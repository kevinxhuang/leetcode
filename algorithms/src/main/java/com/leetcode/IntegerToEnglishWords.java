...
public class IntegerToEnglishWords {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new IntegerToEnglishWords().numberToWords(10000));
        System.out.println(new IntegerToEnglishWords().numberToWords(100000));
        System.out.println(new IntegerToEnglishWords().numberToWords(1000000));
        System.out.println(new IntegerToEnglishWords().numberToWords(1000001));
    }
}
