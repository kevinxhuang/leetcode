...
public class HouseRobber {
	...
	public static void main(String[] args) {
		System.out.println(new HouseRobber().rob(new int[]{1}));
		System.out.println(new HouseRobber().rob(new int[]{1,2}));
		System.out.println(new HouseRobber().rob(new int[]{1,2,3}));
		System.out.println(new HouseRobber().rob(new int[]{1,3,2}));
	}
